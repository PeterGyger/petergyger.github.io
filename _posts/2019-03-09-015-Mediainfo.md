...
* [Website des Projektes](https://mediaarea.net/en/MediaInfo)
* [GitHub](https://github.com/MediaArea/MediaInfo)
* [Installation MediaInfo CLI über Chocolatey](https://chocolatey.org/packages/mediainfo-cli)
* [Ubuntuusers.de: MediaInfo](https://wiki.ubuntuusers.de/MediaInfo/#Erweiterte-Abfragemoeglichkeiten)
* [Fossi: CLI Referenz](https://fossies.org/linux/MediaInfo_CLI/MediaInfo/Contrib/CLI_Help.doc)
* [AskUbuntu: short summary about video files (resolution, size, duration, codec)](https://askubuntu.com/questions/577421/short-summary-about-video-files-resolution-size-duration-codec))